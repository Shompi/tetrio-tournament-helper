export const CommonErrors = {
	...
	PlayerNotRegistered: 'No estás inscrito/a en este torneo.',
	CheckInNotAllowed: 'No puedes hacer Check-in en este torneo por que ya ha finalizado.',
	AlreadyCheckedIn: 'Ya estás en la lista de Checked-in.',
	NotImplemented: "⛔ Esta opción aún no ha sido implementada.",
